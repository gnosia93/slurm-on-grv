...
```
see there is no --node_rank parameter, for slurm to refer rank information, you have to modify training source code (cifar10-vgg.py).
check cifar10-vgg.py source code from line number .. .. to ... 
